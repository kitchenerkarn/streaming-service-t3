      ...
      <main className="flex min-h-screen flex-col items-center overflow-x-hidden">
        ...
        <section className="billboard h-[75vh] w-full overflow-y-hidden md:h-[85vh]">
          <div className="absolute top-32 w-full flex-col px-8 text-center md:px-16 md:text-start">
            <div className="w-full pb-6 md:w-[390px] 2xl:w-[800px]">
              <h1 className="text-5xl 2xl:text-7xl font-bold">{highlighted?.title}</h1>
            </div>
            <div className="pb-2">
              <span className="text-zinc-200 2xl:text-xl">
